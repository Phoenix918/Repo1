...
resource "null_resource" "nullresource"  {
 ...
 depends_on = [
   aws_instance.i2,
    ...
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/KIIT/Desktop/CC/terraform/Task2/TK3.pem")
...
depends_on = [
	...
	provisioner "local-exec" {
	    command = "chrome  http://${aws_instance.i2.public_ip}/s2.html"
  	}
}
